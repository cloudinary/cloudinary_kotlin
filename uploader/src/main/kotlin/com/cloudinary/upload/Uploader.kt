    ...
    companion object {
        ...
        fun <T> prepareNetworkRequest(
            ...
            if (requiresSigning(action, paramsMap, request) || paramsMap["signature"] != null)  {
                ...
                paramsMap["timestamp"] = paramsMap["timestamp"] ?: (System.currentTimeMillis() / 1000L).asCloudinaryTimestamp()
                paramsMap["signature"] = paramsMap["signature"] ?: apiSignRequest(paramsMap, apiSecret)

...
/*
       ...
       cloudinary.url {
           publicId("sample")
           effect(Effect.styleTransfer(false) {
       ...
       cloudinary.url {
           ...
           resize(Resize.fill  {
               height(400)
               aspectRatio(0.8)
               gravity(Gravity.auto:ocrTextAvoid())
               })
           }.generate()
       ...
       cloudinary.url {
           publicId("sample")
           resize(Resize.fill(700, 700))
           effect(Effect.styleTransfer(60, false) {
               overlay(Layer.image("lighthouse"))
               })
           }.generate()
       ...
       cloudinary.url {
           publicId("sample")
           resize(Resize.fill(700, 700))
           effect(Effect.styleTransfer("preserve_color", false) {
               overlay(Layer.image("lighthouse"))
               })
           }.generate()
       ...
       cloudinary.url {
           publicId("sample")
           resize(Resize.fill(700, 700))
           effect(Effect.styleTransfer(40, true) {
               overlay(Layer.image("lighthouse"))
               })
           }.generate()
       ...
       cloudinary.url {
           publicId("sample")
           format(Format.auto())
           addFlag(Flag.attachment:prettyFlower())
           }.generate()
       ...
       cloudinary.url {
           ...
           effect(Effect.pixelateRegion(15))
           gravity(Gravity.ocrText())
           }.generate()
       ...
       cloudinary.url {
           ...
           resize(Resize.thumbnail(400) {
               aspectRatio(1)
               gravity(Gravity.auto:skateboard())
               })
           }.generate()
       ...
       cloudinary.url {
           ...
           resize(Resize.fill(500) {
               aspectRatio(1.0)
               gravity(Gravity.auto:personAvoid())
               })
           }.generate()
       ...
       cloudinary.url {
           ...
           resize(Resize.thumbnail(600) {
               aspectRatio(1)
               gravity(Gravity.auto:microwave())
               })
           }.generate()
       ...
       cloudinary.url {
           ...
           resize(Resize.thumbnail(600) {
               aspectRatio(1)
               gravity(Gravity.auto:refrigerator())
               })
           }.generate()
       ...
       cloudinary.url {
           publicId("sample")
           variable("small", 150, "big", "2 * \$small")
       ...
       cloudinary.url {
           publicId("sample")
           variable("small", 150, "big", "2 * \$small + 4")
           resize(Resize.fill("\$big", "\$small + 20"))
           }.generate()
       ...
       750 examples, 0 failures, 750 passed

       Finished in 0.735391 seconds
